    ...
    <div class="container">
        ...
        <form action="result.php" method="post">
            ...
            while ($row = $stmt->fetch()) {
                ...
                echo '<label class="form-check-label">' . htmlspecialchars($row['option_a']) . '</label>';
                echo '</div>';
                echo '<div class="form-check">';
                echo '<input class="form-check-input" type="radio" name="answer' . $row['id'] . '" value="B">';
                echo '<label class="form-check-label">' . htmlspecialchars($row['option_b']) . '</label>';
                echo '</div>';
                echo '<div class="form-check">';
                echo '<input class="form-check-input" type="radio" name="answer' . $row['id'] . '" value="C">';
                echo '<label class="form-check-label">' . htmlspecialchars($row['option_c']) . '</label>';
                echo '</div>';
                echo '<div class="form-check">';
                echo '<input class="form-check-input" type="radio" name="answer' . $row['id'] . '" value="D">';
                echo '<label class="form-check-label">' . htmlspecialchars($row['option_d']) . '</label>';
                echo '</div>';
                echo '</div>';
                $i++;
            }
